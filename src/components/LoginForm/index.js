      ...
      <div className="bg-container">
        <div className="inner-container">
          ...
          <form onSubmit={this.submitForm}>
            <div className="form-inner-container">{this.renderUserName()}</div>
            <div className="form-inner-container">{this.renderPassword()}</div>
            <button className="button" type="submit">
              Login
            </button>
            {showErrorMessage ? <p className="errorMsg">*{errorMsg}</p> : null}
          </form>
        </div>
      </div>
    )
